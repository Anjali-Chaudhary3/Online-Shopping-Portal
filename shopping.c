...
int main()
{
 ...
 do{
  ...
  case 1:
  {
    ...
    switch(accessoriesChoice)
    {
     ...
     {
      int num;
      printf("\nYou choosed Keyboard with Rs.355.Enter 1 for 'Yes' Enter 1 else other number\n");
      scanf("%d",&num);
      if(num==1)
      {
      a[0]++;
     ...
     {
      int num;
      printf("\nYou choosed Logitech Mouse with Rs.500.Enter 1 for 'Yes' Enter 1 else other number\n");
      scanf("%d",&num);
      if(num==1)
      {
      a[1]++;
     ...
     {
      int num;
      printf("\nYou choosed Pendrive 16GB with Rs.550.Enter 1 for 'Yes' else other number\n");
      scanf("%d",&num);
      if(num==1)
      {
      a[2]++;
  ...
  case 2:
  {
    ...
    switch(shoesChoice)
    {
     ...
     {
      int num;
      printf("\nYou choosed Adidas Shoes for Rs.3550. Enter 1 for 'Yes' else other number\n");
      scanf("%d",&num);
      if(num==1)
      {
      a[3]++;
     ...
     {
      int num;
      printf("\nYou choosed Nike Shoes for Rs.5000. Enter 1 for 'YES' else other number\n");
      scanf("%d",&num);
      if(num==1)
      {
      a[4]++;
     ...
     {
      int num;
      printf("\nYou choosed `Leecooper Shoes for Rs.2800. Enter 1 for 'YES' else other number \n");
      scanf("%d",&num);
      if(num==1)
      {
      a[5]++;
  ...
  if(a[i]!=0)
  {
    printf("%d\t %s\t  \t%d \t\t %d\t ",i,items[i],a[i],(cost[i]*a[i]));
  }
  }
  printf("\nTotal Cost\t\t\t\t\t%d\n",totalCost);
 ...
 printf("\nThanks %s for the purchase , please visit again \n",str);
